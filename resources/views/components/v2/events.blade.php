...
<div @class($class)>
    ...
    <x-widget.section
        :id="$id ?? null"
        :lazyload="true"
        :bg-image="asset('v2/img/events/headers/2beach-club-events-headers-001.webp')"
        :bg-image-mini="asset('v2/img/events/headers/2beach-club-events-headers-001-1.webp')"
        :bg-class="['w-100']"
